            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{route("vacaciones.insertar")}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="fecha_ini" value="{{old('fecha_ini')}}" required="">
                                </div>
                            </div>
                            @error('fecha_ini')
                                <div class="alert alert-danger alert-dismissable">{{$message}}<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button></div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <button class="btn btn-danger " type="button" onclick="location.href='{{route('vacaciones.index')}}'">Cancelar</button>
