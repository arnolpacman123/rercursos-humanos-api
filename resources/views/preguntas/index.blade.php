        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('preguntas.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("preguntas.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($preguntas as $pregunta)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($pregunta->created_at) }}</td>
                                    <td data-texto="{{$pregunta->nombre}}">
                                        <a href="{{route('preguntas.mostrar',$pregunta->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('preguntas.modificar',$pregunta->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
                                        <a data-ruta="{{route('preguntas.eliminar',$pregunta->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
