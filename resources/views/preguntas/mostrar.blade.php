                    ...
                    <div class="ibox-content">
                        <form >
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10"><input type="text" class="form-control" value="{{$pregunta->pregunta}}" disabled=""></div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10"><input type="text" class="form-control" value="{{$pregunta->tipo}}" disabled=""></div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Plantilla</label>
                                <div class="col-sm-10"><input type="text" class="form-control" value="{{$pregunta->plantilla_id}}" disabled=""></div>
                            </div>
                            <div class="form-group row">
