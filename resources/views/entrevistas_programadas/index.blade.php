        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('entrevistas_programadas.agregar')}}">Agregar</a>
                            ...
                            @foreach($entrevistas_programadas as $entrevista_programada)
                                <tr>
                                    ...
                                    <td data-texto="{{$entrevista_programada->id}}">
                                        <a href="{{route('entrevistas_programadas.mostrar',$entrevista_programada->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('entrevistas_programadas.modificar',$entrevista_programada->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
