        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('horarios.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("horarios.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($horarios as $horario)
                                <tr>
                                    ...
                                    <td>{{$horario->dia}}</td>
                                    <td>{{$horario->hora_ing}}</td>
                                    <td>{{$horario->hora_sal}}</td>
                                    ...
                                    <td>{{fecha_latina($horario->created_at) }}</td>
                                    {{--<td data-texto="{{$horario->titulo}}">--}}
                                        <a href="{{route('horarios.mostrar',$horario->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('horarios.modificar',$horario->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
                                        <a data-ruta="{{route('horarios.eliminar',$horario->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
