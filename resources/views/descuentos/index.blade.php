                        ...
                        <tbody>
                            @foreach($descuentos as $descuento)
                                <tr>
                                    ...
                                    <td data-texto="{{$descuento->titulo}}">
                                        <a href="{{route('descuentos.mostrar',$descuento->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('descuentos.modificar',$descuento->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
