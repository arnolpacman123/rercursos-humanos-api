        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('faltas.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("faltas.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($faltas as $falta)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($falta->created_at) }}</td>
                                    <td>
                                        <a href="{{route('faltas.mostrar',$falta->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
