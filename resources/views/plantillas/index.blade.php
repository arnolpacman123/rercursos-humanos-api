        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('plantillas.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("plantillas.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($plantillas as $plantilla)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($plantilla->created_at) }}</td>
                                    <td data-texto="{{$plantilla->nombre}}">
                                        <a href="{{route('plantillas.mostrar',$plantilla->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('plantillas.modificar',$plantilla->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
                                        {{--<a data-ruta="{{route('plantillas.eliminar',$plantilla->id)}}" class="btn-eliminar" title="Editar Contenido"><img width="17px" src="{{asset('img/iconos/editarcont.png')}}" alt="Eliminar"></a>--}}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
