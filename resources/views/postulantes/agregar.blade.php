            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <a class="btn btn-primary" href="{{route('postulantes.index')}}">Listado</a>
                        <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                    </div>
                    <div class="ibox-content">
                        <form action="{{route("postulantes.insertar")}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Curriculum:<i class="text-danger">*</i></label>
                                <div class="col-sm-10"><input type="file" class="form-control" name="curriculum" value="{{old('curriculum')}}" required=""></div>
                            </div>
                            @error('motivo')
                            <div class="alert alert-danger alert-dismissable">{{$message}}<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button></div>
                            @enderror
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <button class="btn btn-danger " type="button" onclick="location.href='{{route('postulantes.index')}}'">Cancelar</button>
